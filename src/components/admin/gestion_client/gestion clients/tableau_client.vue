...
const appel_offre = () =>{
  ...
  const tableau  = ref([
  {nom_entreprise: 'Yeo SA', email: 'yeosa@gmail.com', numero: '0556894212', statut: 'abonné',localisation: 'Bingerville Zone 3',secteur_activite: 'Informatique'},
  {nom_entreprise: 'Yeo SA', email: 'yeosa@gmail.com', numero: '0556894212', statut: 'abonné',localisation: 'Bingerville Zone 3', secteur_activite: 'Informatique'},
  { nom_entreprise: 'Yeo SA', email: 'yeosa@gmail.com', numero: '0556894212', statut: 'abonné',localisation: 'Bingerville Zone 3', secteur_activite: 'Informatique'},
            ...
            <div class="flex">
              <label>               
                    <select required name="" id="">
                      ...
                      <option v-for="country in countries" :value="country.alpha2Code" :key="country.alpha2Code">{{ country.name.common }}</option>
                    </select>
              </label>
            </div>  
        ...
        <table>
          ...
          <tbody>
              <tr v-for="(ligne, index) in tableau" :key="index">
                  <td class="">
                    <img :src="ligne.logo" class="profile">
                  </td>                               
                  <td class="">{{ligne.nom_entreprise}}</td>   
                  <td class="">{{ligne.email}}</td>
                  <td class="">{{ligne.localisation}}</td> 
                  <td class="">{{ligne.numero}}</td>   
                  <td class="">{{ligne.secteur_activite}}</td>  
